...
router.post("/operatingRoom/:branch/createNew", validateJwt, createOperatingRoomCleanUp);
router.get("/operatingRoom/:branch", validateJwt, getOperatingRoomCleanUps);
router.patch("/operatingRoom/:branch/:operatingRoomCleanUpId", validateJwt, updateOperatingRoomCleanUp);
