...
const { createFcmPartner, getAllFcmPartner, getFcmPartner, updateFcmPartner, deleteFcmPartner, insertDummy, getFcmPartnerByPartnerNum, createDog, getAllDogs, getDog, updateDog, deleteDog, createFcmPackage, getAllFcmPackages, getFcmPackage, updateFcmPackage, deleteFcmPackage, createFcmTransfer, getAllFcmTransfers, getFcmTransfer, updateFcmTransfer, deleteFcmTransfer, getAllFcm, } = require("../controllers/fcmController");
...
router.get("/partners/partner/:partnerNum", validateJwt, getFcmPartnerByPartnerNum);
