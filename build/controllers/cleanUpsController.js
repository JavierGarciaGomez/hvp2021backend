...
dayjs.extend(utc);
const getAllCleanUpsFromLastMonth = (req, res = response) =>
...
const getDailyCleanUpsAndGenerate = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      for (i = 0; i < 7; i++) {
        ...
        let dailyCleanUp = yield DailyCleanup.findOne({
          date: newDate,
          branch,
        });
        if (!dailyCleanUp) {
...
const updateDailyCleanUp = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // update it
      const updatedDailyCleanUp = yield DailyCleanup.findByIdAndUpdate(
        dailyCleanUpId,
        dailyCleanUp,
        { new: true }
      );
...
const createDeepCleanUp = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const date = dayjs();
      const {
...
const updateDeepCleanUp = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (comment)
        deepCleanUp.comments.push({ comment, creator: collaborator });
      const updatedDeepCleanUp = yield DeepCleanUp.findByIdAndUpdate(
        deepCleanUpId,
        Object.assign({}, deepCleanUp),
        { new: true }
      );
      res.status(201).json({
        ok: true,
...
const getDeepCleanUps = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { branch } = req.params;
      const date = dayjs().utc(true).startOf("day");
...
const getDeepCleanUp = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { deepCleanUpId } = req.params;
      let deepCleanUp = yield DeepCleanUp.findById(deepCleanUpId);
...
const createOperatingRoomCleanUp = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { branch } = req.params;
      const { uid } = req;
...
const getOperatingRoomCleanUps = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { branch } = req.params;
      const date = dayjs().utc(true).startOf("day");
...
const updateOperatingRoomCleanUp = (req, res = response) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { operatingRoomCleanUpId } = req.params;
      const { action, comment } = req.body;
      const { uid } = req;
      let operatingRoomCleanUp = yield OperatingRoomCleanUp.findById(
      ...
      const currentDate = dayjs();
      if (!validateMaxDays(date, currentDate, 3)) {
        return res.status(404).json({
          ok: false,
          msg: "No puedes actualizar un registro antiguo",
        });
      ...
      switch (action) {
        ...
        case cleanUpActions.addSupervisor:
          ...
          break;
        case cleanUpActions.addComment:
          operatingRoomCleanUp.comments.push({
            comment,
      ...
      const updatedOperatingRoomCleanUp =
        yield OperatingRoomCleanUp.findByIdAndUpdate(
          operatingRoomCleanUpId,
          operatingRoomCleanUp,
          { new: true }
        );
