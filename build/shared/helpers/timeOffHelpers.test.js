...
const timeOffRequestsFixtures_1 = __importDefault(require("../../pending/tests/fixtures/timeOffRequestsFixtures"));
...
describe("timeOffHelpers", () => {
    describe("getNotRejectedVacations", () => {
        test("getNotRejectedTimeOffsByType returns correct filtered days", () => {
            ...
            const result = (0, timeOffHelpers_1.getNotRejectedTimeOffsByType)(timeOffRequests, interfaces_1.TimeOffType.partialPermission);
    ...
    describe("getPendingVacations", () => {
        ...
        test("returns an empty array for no pending vacation requests", () => {
            const timeOffRequests = [
                {
                    timeOffType: interfaces_1.TimeOffType.vacation,
                    status: interfaces_1.TimeOffStatus.approved,
                    requestedDays: [new Date("2023-01-01")],
                },
                {
                    timeOffType: interfaces_1.TimeOffType.dayLeave,
                    status: interfaces_1.TimeOffStatus.rejected,
    ...
    describe("calculateVacationDaysForYearBefore2023", () => {
        test("returns correct number of vacation days for various years of working", () => {
            ...
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(6)).toBe(14);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(10)).toBe(16);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(11)).toBe(16);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(15)).toBe(18);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(16)).toBe(18);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(20)).toBe(20);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(21)).toBe(20);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(25)).toBe(22);
            expect((0, timeOffHelpers_1.calculateVacationDaysForYearBefore2023)(26)).toBe(22);
    ...
    describe("calculateYears", () => {
        test("returns correct number of years between two dates when endDate is not sent", () => {
            ...
            expect((0, timeOffHelpers_1.calculateYears)(startDate)).toBeCloseTo(expectedYears);
    ...
    describe("getLastAnniversaryDate", () => {
        it("should return the last anniversary date", () => {
            ...
            const result = (0, timeOffHelpers_1.getLastAnniversaryDate)(startDate).toISOString();
