...
const taskSchema = new mongoose_1.Schema({
    ...
    priority: {
        type: String,
        enum: Object.values(taskTypes_1.TaskPriority),
        default: taskTypes_1.TaskPriority.Low,
    },
    requestedAt: { type: Date, default: Date.now },
    status: {
        type: String,
        enum: Object.values(taskTypes_1.TaskStatus),
        default: taskTypes_1.TaskStatus.Backlog,
    },
    tags: [{ type: String, enum: Object.values(taskTypes_1.TaskTag) }],
