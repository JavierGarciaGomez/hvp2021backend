...
/************ CRUD ALL********* */
const getAllFcm = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get partners
...
const createFcmPartner = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
...
// get all
const getAllFcmPartner = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        let allFcmPartners = yield FcmPartner.find().populate("creator", "col_code");
        res.json({
            ok: true,
...
const getFcmPartner = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
...
const getFcmPartnerByPartnerNum = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
...
// get from a user
const updateFcmPartner = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        const { uid } = req;
        // get the id
        const id = req.params.id;
...
const deleteFcmPartner = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
        let fcmPartner = yield FcmPartner.findById(id);
...
/************ CRUD DOGS********* */
const createDog = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // check who is doing the register
        const { uid } = req;
        const data = Object.assign({}, req.body);
...
// get all
const getAllDogs = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
...
const getDog = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
        console.log("getfcm", id);
...
const updateDog = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        const { uid } = req;
        // get the id
        const id = req.params.id;
...
const deleteDog = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
        let dog = yield FcmDog.findById(id);
...
/************ FCMTRANSFER ********* */
const createFcmTransfer = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // check who is doing the register
        const { uid } = req;
        const data = Object.assign({}, req.body);
...
// get all
const getAllFcmTransfers = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
...
const getFcmTransfer = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
        console.log("getfcm", id);
...
const updateFcmTransfer = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        const { uid } = req;
        // get the id
        const id = req.params.id;
...
const deleteFcmTransfer = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
        let fcmTransfer = yield FcmTransfer.findById(id);
...
/************ PACKAGES ********* */
const createFcmPackage = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // check who is doing the register
        const { uid } = req;
        const data = Object.assign({}, req.body);
...
// get all
const getAllFcmPackages = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
...
const getFcmPackage = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
        console.log("getfcm", id);
...
const updateFcmPackage = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
...
const deleteFcmPackage = (req_1, ...args_1) => __awaiter(void 0, [req_1, ...args_1], void 0, function* (req, res = response) {
    try {
        // get the id
        const id = req.params.id;
        let myPackage = yield FcmPackage.findById(id);
