---
title: "QVET Integration: Download and read suppliers report"
...
priority: "low"
estimated_hours: 1
tags: ["qvet", "integration", "suppliers", "poc"]
---

# QVET Integration: Download and Read Suppliers Report

> **GitHub Issue:** [GH15 - QVET Integration: Download and read suppliers report](https://github.com/JavierGarciaGomez/hvp2021backend/issues/15)
> **Created:** 2026-01-02
> **Status:** Active
...
**What:** Create a proof-of-concept script that downloads the Suppliers report (ID 508) from QVET, parses the Excel file, and displays the data structure.

**Why:**
- **Validate QVET integration:** Verify existing QVET API client works for reports
- **Understand data structure:** Document supplier data fields for future sync implementation
- **Foundation for automation:** First step toward automated supplier synchronization
- **Risk mitigation:** Test integration before building full sync system
...
### In Scope
- Script to download Suppliers report (ID 508) from QVET
- Excel parsing using `xlsx` library
- Display first 2 rows of data in console
- Document actual data structure found
- NPM script for easy execution
- Reuse existing QVET API client code

### Out of Scope
- Data synchronization with MongoDB (future enhancement)
- API endpoints for manual sync (not needed yet)
- Automated scheduling/cron jobs (future enhancement)
- Error notifications (future enhancement)
- Other QVET reports beyond Suppliers
