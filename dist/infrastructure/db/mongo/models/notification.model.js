...
const NotificationSchema = new mongoose_1.Schema({
    user: { type: mongoose_1.Schema.Types.ObjectId, ref: "Collaborator", required: true },
    title: { type: String, required: true },
    message: { type: String, required: true },
    referenceId: { type: String, required: true },
    referenceType: {
        type: String,
        enum: Object.values(enums_1.NotificationReferenceType),
        required: true,
    },
    actionType: {
        type: String,
        enum: Object.values(enums_1.NotificationActionType),
        required: true,
    },
